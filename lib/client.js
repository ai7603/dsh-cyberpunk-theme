		...
		function cyberpunkClientPlugin() {
			return { apply(ctx) {
				...
				function patch(p) {
					...
					if (p.perf !== void 0) document.documentElement.setAttribute("data-cp-perf", state.perf);
					state.version += 1;
...
`;
				...
				function CyberSettings() {
					...
					return react.createElement("div", { className: "cp-settings" }, react.createElement("h2", { className: "cp-settings-title" }, "Cyberpunk 2077"), react.createElement("p", { className: "cp-settings-sub" }, "Night City reskin for the DSH shell. Dark mode shows the full neon look."), react.createElement("div", { className: "cp-group" }, react.createElement("div", { className: "cp-group-label" }, "Color scheme"), react.createElement("div", { className: "cp-row" }, schemeBtns), react.createElement("p", { className: "cp-note" }, "Current: ", react.createElement("strong", null, schemeLabel()), " (", activeScheme === "dark" ? "dark palette active" : "light palette active", ")")), react.createElement("div", { className: "cp-group" }, react.createElement("div", { className: "cp-group-label" }, "Accent"), react.createElement("div", { className: "cp-row" }, accentBtns)), react.createElement("div", { className: "cp-group" }, react.createElement("div", { className: "cp-group-label" }, "Performance"), react.createElement("div", { className: "cp-row" }, perfBtns), react.createElement("p", { className: "cp-note" }, "Balanced (default): no full-screen glitch, slower ribbon & brand. Eco: all motion off — coolest Mac.")), react.createElement("div", { className: "cp-group" }, react.createElement("label", { className: "cp-toggle" }, react.createElement("input", {
						type: "checkbox",
						checked: st.grid,
						onChange: function(e) {
